<div class="space-y-6">
    <div class="flex items-center justify-between gap-3">
        <div>
            <div class="text-sm font-semibold">Contactpersonen</div>
    ...
    <div class="overflow-hidden rounded-xl border border-zinc-200">
        <table class="min-w-full divide-y divide-zinc-100 bg-white">
            ...
            <tbody class="divide-y divide-zinc-100">
                ...
                @empty
                    <tr>
                        <td colspan="5" class="px-4 py-10 text-center text-sm text-zinc-600">Nog geen contactpersonen.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
    ...
    @if($showForm)
        <div class="rounded-xl border border-zinc-200 bg-white p-5">
            <div class="flex items-center justify-between gap-3">
                <div class="text-sm font-semibold">{{ $personId ? 'Contactpersoon bewerken' : 'Contactpersoon toevoegen' }}</div>
